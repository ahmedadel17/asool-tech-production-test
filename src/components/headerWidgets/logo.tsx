  ...
  return (
    ...
    <a href="index.php" className="flex items-center gap-3 no-underline">
     { process.env.NEXT_PUBLIC_LOGO ? (
       ...
       <>
       <div className="w-10 h-10 bg-gradient-to-br from-primary-500 to-secondary-500 rounded-lg flex items-center justify-center text-white font-bold text-lg">T</div>
