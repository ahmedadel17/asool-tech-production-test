...
function PointsHistory() {
    ...
    const getTransactions = useCallback(async (page: number = 1) => {
        ...
        try {
            ...
            const response = await getRequest(
                `/customer/points-history?${queryParams.toString()}`,
  ...
  return (
    <div className="lg:col-span-3 space-y-8">
        ...
        <DashboardHeader title={t("Points Transaction History")} description={t("Complete log of all your points activities and conversions")} />
