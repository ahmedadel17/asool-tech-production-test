...
//   const defaultPlaceholder = placeholder || ("Phone Number Placeholder");
//   const defaultLabel = label || ("Phone Number");
...
//       const translatedName = country.name;
//       return (
...
//         Enter your {state.selectedCountry.name} phone number (7-11 digits)
//       </p>
