        ...
        <div id="description" className="tab-panel">
            ...
            <div className="space-y-6 text-gray-700 dark:text-gray-300">
                <p className="leading-relaxed">
                    Experience ultimate comfort with our Mercer 7 Inch Chino Shorts. Made from 100% organic cotton with a soft, breathable fabric thats perfect for everyday wear. Features a classic fit and durable construction that maintains its shape wash after wash.
                </p>
                    ...
                    <div>
                        <div className="space-y-2">
                            ...
                            <div className="flex items-center">
                                ...
                                <div className="flex-1 mx-2">
                                    <div className="bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                                        <div className="bg-yellow-400 h-2 rounded-full" style={{width:'13%'}}></div>
                                    </div>
                                </div>
