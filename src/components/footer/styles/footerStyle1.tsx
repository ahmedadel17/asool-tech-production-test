  ...
  <footer className="te-footer flex-shrink-0">
    <div className="container">
        ...
        <div className="te-footer-content">
            ...
            {menuData && Array.isArray(menuData?.footer_menus) && menuData?.footer_menus[0]?.items?.map((menu: any) => (
...
<div className="te-footer-widget footer-widget-1">
    <div className="footer-widget">
        ...
        <div className="te-footer-app-download">
            <a href={menuData?.settings?.ios_customer_app} className="w-full sm:w-auto bg-gray-800 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 text-white rounded-lg flex items-center justify-center px-4 py-2.5 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
        ...
        <a href={menuData?.settings?.android_customer_app} className="mt-2 w-full sm:w-auto bg-gray-800 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 text-white rounded-lg flex items-center justify-center px-4 py-2.5 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
