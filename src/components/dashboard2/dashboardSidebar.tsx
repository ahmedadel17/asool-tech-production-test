  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            ...
            <div className="flex items-center mb-6 pb-6 border-b border-gray-200 dark:border-gray-600">
                ...
                <div className="ms-4">
                    <h3 className="font-semibold text-gray-900 dark:text-white">{user?.first_name + ' ' + user?.last_name || 'User'}</h3>
                    <p className="text-sm text-gray-600 dark:text-gray-400">{user?.email || 'No email found'}</p>
                </div>
            </div>
