...
const footerPlugin = plugin(function ({ addComponents, theme }) {
  addComponents({
    ...
    ==================== */
    ".te-footer": {
      backgroundImage: `linear-gradient(to left, ${theme("colors.gray.900")}, ${theme("colors.gray.900")})`,
      backgroundColor: theme("colors.gray.900"), // Fallback color
      color: theme("colors.gray.300"),

      ".dark &": {
        backgroundImage: `linear-gradient(to left, ${theme("colors.gray.800")}, ${theme("colors.gray.800")})`,
